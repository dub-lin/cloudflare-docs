...
description: Speed Brain enhances web performance by prefetching likely next pages, improving metrics like LCP and TTFB. Works with Chromium-based browsers v121+.
---
