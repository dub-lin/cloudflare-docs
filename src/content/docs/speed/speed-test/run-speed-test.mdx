...
sidebar:
  order: 2
description: Run speed tests on your website using Cloudflare's Observatory. Get detailed performance metrics, Lighthouse scores, and improvement recommendations for desktop and mobile.
