...
Internal DNS queries can only be resolved by using the Cloudflare Gateway, which acts as an interface between the client and the internal zone.
...
flowchart LR
        ...
        Y[example.com <br /> Zone 200]
				Z[example.net <br /> Zone 201]
        end
        subgraph View 110 - San Francisco
        X[example.local <br /> Zone 301]
				B[example.net <br /> Zone 300]
				S[local <br /> Zone 302]
        end
				W[net <br /> Zone 501]
				end
